...
export class AddNotesUsecaseDom extends Command<Promise<Result<NotesDom, Failure>>, NotesRequestDom> {
  ...
  execute = async (param: NotesRequestDom): Promise<Result<NotesDom, Failure>> => this.notesRepositoryDom.add(param);
}
